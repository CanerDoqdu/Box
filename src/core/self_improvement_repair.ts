 ...
 */
export async function persistSelfImprovementDecision(config, phase, analysis, context: any = {}) {
 ...
 */
export async function escalateRepairFailure(config, analysis, context: any = {}) {
